...
export class TaskService {
    ...
    removeTask(task: any): void {
        ...
        // this._http.delete('/api/tasks/'+task._id+'.json')
    ...
    create(task: any) {
        ...
        // this._http.post('/api/tasks.json', JSON.stringify({'title': task.title}) )
        // .map((response: Response)  => response.json())
        // .toPromise()
        // .catch(this.handleError)
        // .then(response => {
  ...
  <div class="row">
    ...
    <ul>
      <li *ngFor="let task of taskService.tasks">
        ...
        <button (click)="taskService.complete(task)">Complete</button>
        <button (click)="taskService.removeTask(task)">Remove</button>
      </li>
